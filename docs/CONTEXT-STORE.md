...
- `.projects/contracts` registry artifacts are indexed as pointers/summaries. Agents should search first and load individual contract files only when needed.
