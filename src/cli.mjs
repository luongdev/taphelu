...
Usage:
  ...
  dl contracts init --path .projects/contracts [--remote url] [--write]
  dl contracts link --path .projects/contracts [--write]
  dl contracts scan [--path .] [--contracts-path .projects/contracts] [--write]
  dl contracts current [--path .] [--contracts-path .projects/contracts]
  dl contracts deps [--service id] [--direction outbound|inbound|all] [--path .] [--contracts-path .projects/contracts]
  dl contracts map [--path .projects/contracts] [--write]
  dl contracts check [--path .projects/contracts] [--strict]
  dl contracts sync [--path .projects/contracts] [--commit] [--push]
